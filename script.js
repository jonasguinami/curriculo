...
const translations = {
    pt: {
        ...
        certNames: {
            ...
            "Certificado-Cultura-em-Movimento-CIEE": "Cultura em Movimento (CIEE)",
            "Certificado-Futur.E": "Futur.E (Fiergs)",
            "Certificado-IEL": "Programa IEL de Estágio e Trainee",
            "Certificado-Algoritmos-e-lógica-de-programação-completo-Udemy": "Algoritmos e Lógica de Programação Completo",
            "Certificado-1-HTML-CSS-Alura": "HTML & CSS - Parte 1 (Alura)",
            "Certificado-2-HTML-CSS-Alura": "HTML & CSS - Parte 2 (Alura)",
            "Certificado-3-HTML-CSS-Alura": "HTML & CSS - Parte 3 (Alura)",
            "Certificado-4-HTML-CSS-Alura": "HTML & CSS - Parte 4 (Alura)",
            "Certificado-1-JAVASCRIPT-Alura": "JavaScript - Parte 1 (Alura)",
            "Certificado-2-JAVASCRIPT-Alura": "JavaScript - Parte 2 (Alura)",
            "Certificado-3-JAVASCRIPT-Alura": "JavaScript - Parte 3 (Alura)",
            "Certificado-Design-de-Jogos-1-Alura": "Design de Jogos - Parte 1 (Alura)",
            "Certificado-Design-de-Jogos-2-Alura": "Design de Jogos - Parte 2 (Alura)",
            "Certificado-Transformação-Digital-Alura": "Transformação Digital (Alura)",
            "Certificado-Dev-Web-100-horas-Udemy": "Desenvolvedor Web: Do Zero ao Profissional (100h)",
            "Certificado-Inglês-para-falantes-da-lingua-portuguesa-100-horas-Udemy": "Inglês para Falantes de Português (100h)",
            "Dev-Web-13.5-horas-Udemy": "Desenvolvimento Web Completo (13.5h)",
            "Certificado-Python-Enap": "Python para Iniciantes (ENAP)",
            "Certificado-IFSul-CSS": "CSS Básico (IFSul)",
            "Certificado-Design-Gráfico-Udemy": "Design Gráfico para Iniciantes",
            "Certificado-Administrando-Banco-de-Dados-Fundação-Bradesco": "Administrando Banco de Dados (Fundação Bradesco)",
            "Certificado-Implementando-Banco-de-Dados-Fundação-Bradesco": "Implementando Banco de Dados (Fundação Bradesco)",
            "Certificado-Fundamento-Hardware-e-Software-Fundação-Bradesco": "Fundamentos de Hardware e Software (Fundação Bradesco)",
            "Certificado-IA-Fundação-Bradesco": "Introdução à IA (Fundação Bradesco)",
            "Certificado-IA-35-horas-Udemy": "Inteligência Artificial para Iniciantes (35h)",
            "Certificado-Pacote-Office-do-básico-ao-avançado-Udemy": "Pacote Office do Básico ao Avançado",
    ...
    en: {
        ...
        certNames: {
            ...
            "Certificado-Cultura-em-Movimento-CIEE": "Culture in Movement (CIEE)",
            "Certificado-Design-de-Jogos-2-Alura": "Design of Games - Part 2 (Alura)",
            "Certificado-Transformação-Digital-Alura": "Digital Transformation (Alura)",
            "Certificado-Futur.E": "Futur.E (Fiergs)",
            "Certificado-IEL": "IEL Internship and Trainee Program",
            "Certificado-Algoritmos-e-lógica-de-programação-completo-Udemy": "Complete Algorithms and Programming Logic",
            "Certificado-1-HTML-CSS-Alura": "HTML & CSS - Part 1 (Alura)",
            "Certificado-2-HTML-CSS-Alura": "HTML & CSS - Part 2 (Alura)",
            "Certificado-3-HTML-CSS-Alura": "HTML & CSS - Part 3 (Alura)",
            "Certificado-4-HTML-CSS-Alura": "HTML & CSS - Part 4 (Alura)",
            "Certificado-1-JAVASCRIPT-Alura": "JavaScript - Part 1 (Alura)",
            "Certificado-2-JAVASCRIPT-Alura": "JavaScript - Part 2 (Alura)",
            "Certificado-3-JAVASCRIPT-Alura": "JavaScript - Part 3 (Alura)",
            "Certificado-Design-de-Jogos-1-Alura": "Design of Games - Part 1 (Alura)",
            "Certificado-Dev-Web-100-horas-Udemy": "Web Developer: From Zero to Professional (100h)",
            "Certificado-Inglês-para-falantes-da-lingua-portuguesa-100-horas-Udemy": "English for Portuguese Speakers (100h)",
            "Dev-Web-13.5-horas-Udemy": "Complete Web Development (13.5h)",
            "Certificado-Python-Enap": "Python for Beginners (ENAP)",
            "Certificado-IFSul-CSS": "Basic CSS (IFSul)",
            "Certificado-Design-Gráfico-Udemy": "Graphic Design for Beginners",
            "Certificado-Administrando-Banco-de-Dados-Fundação-Bradesco": "Administering Databases (Bradesco Foundation)",
            "Certificado-Implementando-Banco-de-Dados-Fundação-Bradesco": "Implementing Databases (Bradesco Foundation)",
            "Certificado-Fundamento-Hardware-e-Software-Fundação-Bradesco": "Hardware and Software Fundamentals (Bradesco Foundation)",
            "Certificado-IA-Fundação-Bradesco": "Introduction to AI (Bradesco Foundation)",
            "Certificado-IA-35-horas-Udemy": "Artificial Intelligence for Beginners (35h)",
            "Certificado-Pacote-Office-do-básico-ao-avançado-Udemy": "Office Package from Basic to Advanced",
            "Certificado-Cultura-em-Movimento-CIEE": "Culture in Movement (CIEE)", 
        }
    ...
    es: {
        ...
        certNames: {
            ...
            "Certificado-Cultura-em-Movimento-CIEE": "Cultura en Movimiento (CIEE)",
            "Certificado-Futur.E": "Futur.E (Fiergs)",
            "Certificado-IEL": "Programa de Pasantías y Trainee IEL",
            "Certificado-Algoritmos-e-lógica-de-programação-completo-Udemy": "Algoritmos y Lógica de Programación Completo",
            "Certificado-1-HTML-CSS-Alura": "HTML & CSS - Parte 1 (Alura)",
            "Certificado-2-HTML-CSS-Alura": "HTML & CSS - Parte 2 (Alura)",
            "Certificado-3-HTML-CSS-Alura": "HTML & CSS - Parte 3 (Alura)",
            "Certificado-4-HTML-CSS-Alura": "HTML & CSS - Parte 4 (Alura)",
            ...
            "Certificado-2-JAVASCRIPT-Alura": "JavaScript - Parte 2 (Alura)",
            "Certificado-3-JAVASCRIPT-Alura": "JavaScript - Parte 3 (Alura)",
            "Certificado-Design-de-Jogos-1-Alura": "Diseño de Juegos - Parte 1 (Alura)",
            "Certificado-Design-de-Jogos-2-Alura": "Diseño de Juegos - Parte 2 (Alura)",
            "Certificado-Transformação-Digital-Alura": "Transformación Digital (Alura)",
            "Certificado-Dev-Web-100-horas-Udemy": "Desarrollador Web: De Cero a Profesional (100h)",
            "Certificado-Inglês-para-falantes-da-lingua-portuguesa-100-horas-Udemy": "Inglés para Hablantes de Portugués (100h)",
            "Dev-Web-13.5-horas-Udemy": "Desarrollo Web Completo (13.5h)",
            "Certificado-Python-Enap": "Python para Principiantes (ENAP)",
            "Certificado-IFSul-CSS": "CSS Básico (IFSul)",
            "Certificado-Design-Gráfico-Udemy": "Diseño Gráfico para Principiantes",
            "Certificado-Administrando-Banco-de-Dados-Fundação-Bradesco": "Administración de Bases de Datos (Fundación Bradesco)",
            "Certificado-Implementando-Banco-de-Dados-Fundação-Bradesco": "Implementación de Bases de Datos (Fundación Bradesco)",
            "Certificado-Fundamento-Hardware-e-Software-Fundação-Bradesco": "Fundamentos de Hardware y Software (Fundación Bradesco)",
            "Certificado-IA-Fundação-Bradesco": "Introducción a la IA (Fundación Bradesco)",
            "Certificado-IA-35-horas-Udemy": "Inteligencia Artificial para Principiantes (35h)",
            "Certificado-Pacote-Office-do-básico-ao-avançado-Udemy": "Paquete Office de Básico a Avanzado",
        }
    ...
    zh: {
        ...
        certNames: {
            ...
            "Certificado-Cultura-em-Movimento-CIEE": "运动中的文化 (CIEE)",
            "Certificado-Futur.E": "Futur.E (Fiergs)",
            "Certificado-IEL": "IEL 实习与培训项目",
            "Certificado-Algoritmos-e-lógica-de-programação-completo-Udemy": "完整的算法与编程逻辑",
            "Certificado-1-HTML-CSS-Alura": "HTML & CSS - 第1部分 (Alura)",
            "Certificado-2-HTML-CSS-Alura": "HTML & CSS - 第2部分 (Alura)",
            "Certificado-3-HTML-CSS-Alura": "HTML & CSS - 第3部分 (Alura)",
            "Certificado-4-HTML-CSS-Alura": "HTML & CSS - 第4部分 (Alura)",
            "Certificado-1-JAVASCRIPT-Alura": "JavaScript - 第1部分 (Alura)",
            "Certificado-2-JAVASCRIPT-Alura": "JavaScript - 第2部分 (Alura)",
            "Certificado-3-JAVASCRIPT-Alura": "JavaScript - 第3部分 (Alura)",
            "Certificado-Design-de-Jogos-1-Alura": "游戏设计 - 第1部分 (Alura)",
            "Certificado-Design-de-Jogos-2-Alura": "游戏设计 - 第2部分 (Alura)",
            "Certificado-Transformação-Digital-Alura": "数字化转型 (Alura)",
            "Certificado-Dev-Web-100-horas-Udemy": "Web 开发者：从零到专业 (100小时)",
            "Certificado-Inglês-para-falantes-da-lingua-portuguesa-100-horas-Udemy": "葡萄牙语使用者的英语 (100小时)",
            "Dev-Web-13.5-horas-Udemy": "完整的 Web 开发 (13.5小时)",
            "Certificado-Python-Enap": "初学者 Python (ENAP)",
            "Certificado-IFSul-CSS": "基础 CSS (IFSul)",
            "Certificado-Design-Gráfico-Udemy": "初学者平面设计",
            "Certificado-Administrando-Banco-de-Dados-Fundação-Bradesco": "数据库管理 (Bradesco 基金会)",
            "Certificado-Implementando-Banco-de-Dados-Fundação-Bradesco": "数据库实施 (Bradesco 基金会)",
            "Certificado-Fundamento-Hardware-e-Software-Fundação-Bradesco": "硬件与软件基础 (Bradesco 基金会)",
            "Certificado-IA-Fundação-Bradesco": "人工智能入门 (Bradesco 基金会)",
            "Certificado-IA-35-horas-Udemy": "初学者人工智能 (35小时)",
            "Certificado-Pacote-Office-do-básico-ao-avançado-Udemy": "Office 套件从基础到高级",
        }
...
const certificados = [
    ...
    "Certificado-Cultura-em-Movimento-CIEE",
    "Certificado-Futur.E",
    "Certificado-IEL"
];
